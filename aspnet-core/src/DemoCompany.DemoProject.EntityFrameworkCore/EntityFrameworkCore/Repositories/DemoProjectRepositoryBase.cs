...
namespace DemoCompany.DemoProject.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class DemoProjectRepositoryBase<TEntity> : DemoProjectRepositoryBase<TEntity, int>, IRepository<TEntity>
