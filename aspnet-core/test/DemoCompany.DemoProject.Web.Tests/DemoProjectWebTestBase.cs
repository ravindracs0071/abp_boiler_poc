...
{
    public abstract class DemoProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DemoProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DemoProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DemoProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DemoProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DemoProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DemoProjectDbContext, Task<T>> func)
        {
            T result;
